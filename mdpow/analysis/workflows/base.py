...
.. module:: mdpow.analysis.workflows.base
   ...
   Base functions for use with all workflow modules.
"""
...
def directory_paths(parent_directory=None, csv=None):
    """.. function:: directory_paths(parent_directory=None, csv=None)
          :module: mdpow.analysis.workflows.base
...
def directory_iteration(directory_paths, df_save_dir=None, figdir=None, padding=45, width=0.9,
                        ...
                        SMARTS='[!#1]~[!$(*#*)&!D1]-!@[!$(*#*)&!D1]~[!#1]'):
    """.. function:: directory_iteration(directory_paths, df_save_dir=None, figdir=None, padding=45, width=0.9, \
                        solvents=('water','octanol'), interactions=('Coulomb','VDW'), \
                        start=None, stop=None, step=None, \
                        SMARTS='[!#1]~[!$(*#*)&!D1]-!@[!$(*#*)&!D1]~[!#1]')
          :module: mdpow.analysis.workflows.base
