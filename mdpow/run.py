...
def equilibrium_simulation(cfg, solvent, **kwargs):
    ...
    def runMD_or_exit(protocol, params, cfg):
        """run simulation
    ...
    if S.journal.has_not_completed("MD_relaxed_run"):
        ...
        success = wrapper(runMD_or_exit, "MD_relaxed", params, cfg)  # note: MD_relaxed!
    ...
    if S.journal.has_not_completed("MD_NPT_run"):
        ...
        success = wrapper(runMD_or_exit, "MD_NPT", params, cfg)   # note: MD_NPT
